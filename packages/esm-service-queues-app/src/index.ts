...
export const queueTableByStatusMenu = getSyncLifecycle(
  queueTableByStatusMenuComponent,
  options
);

export const appointmentsList = getSyncLifecycle(
...
export const outpatientSideNav = getSyncLifecycle(
  outpatientSideNavComponent,
  options
);

export const serviceQueuesDashboardLink = getSyncLifecycle(
...
export const visitAttributesForm = getSyncLifecycle(
  VisitAttributesForm,
  options
);
...
export const patientInfoBannerSlot = getSyncLifecycle(
  patientInfoBannerSlotComponent,
  {
...
export const pastVisitSummary = getSyncLifecycle(
  pastVisitSummaryComponent,
  options
);
...
export const transitionQueueEntryModal = getAsyncLifecycle(
  () =>
    import(
      "./queue-table/queue-entry-actions/transition-queue-entry-modal.component"
    ),
  {
...
export const editQueueEntryModal = getAsyncLifecycle(
  () =>
    import(
      "./queue-table/queue-entry-actions/edit-queue-entry-modal.component"
    ),
  {
...
export const undoTransitionQueueEntryModal = getAsyncLifecycle(
  () =>
    import(
      "./queue-table/queue-entry-actions/undo-transition-queue-entry-modal.component"
    ),
  {
...
export const voidQueueEntryModal = getAsyncLifecycle(
  () =>
    import(
      "./queue-table/queue-entry-actions/void-queue-entry-modal.component"
    ),
  {
...
export const patientSearchWorkspace = getAsyncLifecycle(
  () => import("./patient-search/patient-search.workspace"),
  {

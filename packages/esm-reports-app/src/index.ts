...
const moduleName = "@intellisoftkenya/esm-reports-app";
...
export function startupApp() {
  ...
  registerBreadcrumbs([
    ...
    },
    {
      ...
      title: () =>
        Promise.resolve(
          window.i18next.t("systemAdmin", "System Administration")
        ),
    ...
    },
    {
      title: () =>
        Promise.resolve(
          window.i18next.t("scheduledReports", "Scheduled Reports")
        ),

  ...
  registerBreadcrumbs([
    {
      ...
      title: () =>
        Promise.resolve(
          window.i18next.t("patientRegistrationBreadcrumb", {
    ...
    },
    {
      ...
      title: () =>
        Promise.resolve(
          window.i18next.t("editPatientDetailsBreadcrumb", {
...
export const addPatientLink = getSyncLifecycle(
  addPatientLinkComponent,
  options
);
...
export const editPatientDetailsButton = getSyncLifecycle(
  editPatientDetailsButtonComponent,
  {
...
export const confirmClientRegistryModal = getAsyncLifecycle(
  () =>
    import(
      "./patient-verification/verification-modal/confirm-prompt.component"
    ),
  options
);

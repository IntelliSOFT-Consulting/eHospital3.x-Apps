...
export function generateIdentifier(source: string) {
  ...
  return openmrsFetch(
    `/ws/rest/v1/idgen/identifiersource/${source}/identifier`,
    {
      headers: {
        "Content-Type": "application/json",
      },
...
export async function updatePatientIdentifier(
  ...
  const abortController = new AbortController();
  return openmrsFetch(
    `/ws/rest/v1/patient/${patientUuid}/identifier/${identifierUuid}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function deletePatientIdentifier(
  ...
  const abortController = new AbortController();
  return openmrsFetch(
    `/ws/rest/v1/patient/${patientUuid}/identifier/${patientIdentifierUuid}?purge`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",

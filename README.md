...
![OpenMRS CI](https://github.com/IntelliSOFT-Consulting/eHospital3.x-Apps/workflows/ci.yml/badge.svg)

# eHospital3.x-Apps

The `eHospital3.x-Apps` is a frontend module for the OpenMRS SPA. It contains various microfrontends that constitute widgets in a patient list. These widgets include:

- [Patient List](packages/esm-patient-list-app/README.md)
